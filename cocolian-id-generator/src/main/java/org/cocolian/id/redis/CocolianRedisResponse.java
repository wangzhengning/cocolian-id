...
/**
 * The response from the Cocolian ID generation script.
 *
 ...
 * library.
 */
public class CocolianRedisResponse {
   ...
   *                will be thrown.
   */
  public CocolianRedisResponse(final List<Long> results) {
  ...
  public boolean equals(final Object o) {
    ...
    CocolianRedisResponse response = (CocolianRedisResponse) o;
